...
node *delete_at_spe_pos(node *p)
{
    ...
    if(x>(a))
    {
        printf("note able to remove node at such position");
        getch();
    }
    else{
        if(x==1)
...
void screen(node *head)
{
    ...
    printf("\n\n11-traverse in order(dispaly)");
    printf("\n\n 12-traverse id reverse order(dispaly)");
    printf("\n\n 13-count no of node");
    ...
    case 3;
            ...
            break;
    case 4;
            head=insert+at_spe_pos(head);
            break;
    case 5;
            head=insert_after_at_spe_pos(head);
            break;
    case 6;
             head=delend(head);
             break;
